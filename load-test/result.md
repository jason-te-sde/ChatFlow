...
- [`/server-v2`](https://github.com/jason-te-sde/ChatFlow/tree/assignment3/server-v2) - WebSocket server with RabbitMQ producer integration
- [`/consumer-v3`](https://github.com/jason-te-sde/ChatFlow/tree/assignment3/consumer-v3) - Consumer application — pulls from queue and broadcasts
- [`/database`](https://github.com/jason-te-sde/ChatFlow/tree/assignment3/database)     -    Schema files and setup scripts
- [`/deployment`](https://github.com/jason-te-sde/ChatFlow/tree/assignment3/deployment)  -   Deployment scripts and configuration guide
- [`/monitoring`](https://github.com/jason-te-sde/ChatFlow/tree/assignment3/monitoring)   -  Monitoring tools and RabbitMQ management guide
- [`/load-tests`](https://github.com/jason-te-sde/ChatFlow/tree/assignment3/load-test)   -  Test configurations and results
...
Note: totalMessages in metrics reflects DB write count at query time (5s after test completion). Batch writer continues flushing asynchronously; final DB count is higher.
System metrics:
